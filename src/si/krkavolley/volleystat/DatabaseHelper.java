...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void writeServe(int gameId, int playerId, int setNumber, int serveType){
		...
		Log.d("hello","hello");
		Cursor cursor = db.query(TABLE_STATS, new String[]{KEY_ID, KEY_PLAYER_ID, KEY_GAME_ID}, KEY_PLAYER_ID + "=? and " + KEY_GAME_ID + "=? and " + KEY_SET + "=?", new String[] {""+playerId, ""+gameId, ""+setNumber}, null, null, null);
		...
		if(cursor.moveToFirst()){
			...
			case 0:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_SERVE_0 + " = " + KEY_SERVE_0 + " + 1 WHERE "
					    + KEY_GAME_ID + " = ? AND " 
						+ KEY_PLAYER_ID + " = ? AND "
						+ KEY_SET + " = ?", new String[]{""+gameId,""+playerId,""+setNumber});
				Log.d("Serve", "Counter 0 increased");
				break;
			case 1:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_SERVE_1 + " = " + KEY_SERVE_1 + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber);
				Log.d("Serve", "Counter 1 increased");
				break;
			case 2:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_SERVE_2 + " = " + KEY_SERVE_2 + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
				Log.d("Serve", "Counter 2 increased");
				break;
			case 3:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_SERVE_3 + " = " + KEY_SERVE_3 + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
			...
			case 4:
				...
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_SERVE_wa + " = " + KEY_SERVE_wa + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
			...
			case 5:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_SERVE_over + " = " + KEY_SERVE_over + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
			...
			case 6:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_SERVE_e + " = " + KEY_SERVE_e + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
	...
	public void writeReception(int gameId, int playerId, int setNumber, int receptionType){
		SQLiteDatabase db = this.getReadableDatabase();
		SQLiteDatabase dbw = this.getWritableDatabase();
		Log.d("hello","hello");
		Cursor cursor = db.query(TABLE_STATS, new String[]{KEY_ID, KEY_PLAYER_ID, KEY_GAME_ID}, KEY_PLAYER_ID + "=? and " + KEY_GAME_ID + "=? and " + KEY_SET + "=?", new String[] {""+playerId, ""+gameId, ""+setNumber}, null, null, null);
		...
		if(cursor.moveToFirst()){
			...
			case 0:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_RECEPTION_0 + " = " + KEY_RECEPTION_0 + " + 1 WHERE "
					    + KEY_GAME_ID + " = ? AND " 
						+ KEY_PLAYER_ID + " = ? AND "
						+ KEY_SET + " = ?", new String[]{""+gameId,""+playerId,""+setNumber});
			...
			case 1:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_RECEPTION_1 + " = " + KEY_RECEPTION_1 + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber);
			...
			case 2:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_RECEPTION_2 + " = " + KEY_RECEPTION_2+ " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
			...
			case 3:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_RECEPTION_3 + " = " + KEY_RECEPTION_3 + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
			...
			case 4:
				...
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_RECEPTION_wa + " = " + KEY_RECEPTION_wa + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
			...
			case 5:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_RECEPTION_over + " = " + KEY_RECEPTION_over + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
	...
	public void writeAttack(int gameId, int playerId, int setNumber, int attackType){
		SQLiteDatabase db = this.getReadableDatabase();
		SQLiteDatabase dbw = this.getWritableDatabase();
		Cursor cursor = db.query(TABLE_STATS, new String[]{KEY_ID, KEY_PLAYER_ID, KEY_GAME_ID}, KEY_PLAYER_ID + "=? and " + KEY_GAME_ID + "=? and " + KEY_SET + "=?", new String[] {""+playerId, ""+gameId, ""+setNumber}, null, null, null);
		...
		if(cursor.moveToFirst()){
			...
			case 0:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_ATTACK_0 + " = " + KEY_ATTACK_0 + " + 1 WHERE "
					    + KEY_GAME_ID + " = ? AND " 
						+ KEY_PLAYER_ID + " = ? AND "
						+ KEY_SET + " = ?", new String[]{""+gameId,""+playerId,""+setNumber});
			...
			case 1:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_ATTACK_1 + " = " + KEY_ATTACK_1 + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber);
			...
			case 2:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_ATTACK_2 + " = " + KEY_ATTACK_2+ " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
			...
			case 3:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_ATTACK_3 + " = " + KEY_ATTACK_3 + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
			...
			case 4:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_ATTACK_e + " = " + KEY_ATTACK_e + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
			...
			case 5:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_ATTACK_ee + " = " + KEY_ATTACK_ee + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
			...
			case 6:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_ATTACK_b + " = " + KEY_ATTACK_b + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
			...
			case 7:
				db.execSQL("UPDATE " + TABLE_STATS +" SET "
						+ KEY_ATTACK_bb + " = " + KEY_ATTACK_bb + " + 1 WHERE "
					    + KEY_GAME_ID + " = " + gameId + " AND " 
						+ KEY_PLAYER_ID + " = " + playerId + " AND "
						+ KEY_SET + " = " + setNumber , null);
